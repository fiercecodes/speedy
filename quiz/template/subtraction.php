        ...
        <div class="card card-md">
          <div class="card-body">
            ...
            <p for="answer" class="h2 text-center mt-3">Answer <img src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/microsoft/310/beaming-face-with-smiling-eyes_1f601.png" alt="" width="25px"></p>
                ...
                <button class="btn btn-success col-12 mt-2" onclick="A123()">Submit</button><p class="text-center mt-2">Also Try: <a href="division.php" class="badge bg-primary">Division</a> <a href="addition.php" class="badge bg-primary">Addition</a> <a href="multiplication.php" class="badge bg-primary">Multiplication</a></p>
            </div>
        </div>
    </div>
</div>
