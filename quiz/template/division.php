<div class="container-tight mt-5 mb-4">
        <div class="card card-md">
          <div class="card-body">
            <h1 class="text-center mb-3">Division - Quiz</h1>
            <label for="question"></label>

            <input class="form-control col-12 ml-2" type="number" placeholder="(generate)" id="question" readonly></input><h4 class="text-center mt-2 mr-2 ml-2"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-divide" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><circle fill="currentColor" cx="12" cy="6" r="1"></circle><circle fill="currentColor" cx="12" cy="18" r="1"></circle><line x1="5" y1="12" x2="19" y2="12"></line></svg></h4>
            ...
            <p for="answer" class="h2 text-center mt-3">Answer <img src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/microsoft/310/beaming-face-with-smiling-eyes_1f601.png" alt="" width="25px"></p>
                ...
                <button class="btn btn-success col-12 mt-2" onclick="A123()">Submit</button><p class="text-center mt-2">Also Try: <a href="division.php" class="badge bg-primary">Division</a> <a href="addition.php" class="badge bg-primary">Addition</a> <a href="subtraction.php" class="badge bg-primary">Subtraction</a></p>
            </div>
        </div>
    </div>
</div>
