...
Speedy Math                      </a>
                    ...
                    <div class="nav-item d-none d-md-flex me-3">
                        <div class="btn-list">
                          <a href="https://github.com/fiercecodes" class="btn btn-outline-white" target="_blank" rel="noreferrer">
                      ...
                      <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                          <span class="avatar avatar-sm" style="background-image: url(./modules/avatar.svg)"></span>
                          <div class="d-none d-xl-block ps-2">
                            <div>Sai Abhijeet</div>
                            <div class="mt-1 small text-muted">Student Developer</div>
                          </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                          <a href="https://forms.gle/KGSP8nGdQ9zwFT1VA" class="dropdown-item">Feedback</a>
                        </div>
                      </div>
                    </div>
